...
//queryParams += '&' + 'serviceKey' + '=' + 'HiKEn%2Binv0Y%2BCuGvVtE6YewIhkFK2DdobGFcYnkTZklGXMupZOVb6wzxN7pncoCcRmILBwq%2F0nqnnqcuvtCuow%3D%3D'; /**/
//queryParams += '&' + 'stationId' + '=' + '200000078'; /**/
//queryParams += '&';

xhr.onreadystatechange = function () {
    if (this.readyState == 4) {
        alert('URL:'+url + queryParams + '  ' +  'Status: '+this.status+'nHeaders: '+JSON.stringify(this.getAllResponseHeaders())+'nBody: '+this.responseText);
    }
};
